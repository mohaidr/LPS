...
namespace LPS.UI.Core.LPSValidators
{
    internal class LPSRunValidator : LPSCommandBaseValidator<LPSHttpRun.SetupCommand, LPSHttpRun>
    {
        ...
        public LPSRunValidator(LPSHttpRun.SetupCommand command)
        {
            ...
            .When(command => command.Mode == LPSHttpRun.IterationMode.CRB && command.BatchSize.HasValue, ApplyConditionTo.CurrentValidator);
            ...
            .When(command => command.Mode == LPSHttpRun.IterationMode.DCB && command.CoolDownTime.HasValue, ApplyConditionTo.CurrentValidator);
            ...
            .When(command => command.Mode == LPSHttpRun.IterationMode.CRB && command.RequestCount.HasValue, ApplyConditionTo.CurrentValidator);
            ...
            .When(command => command.Mode == LPSHttpRun.IterationMode.DCB && command.Duration.HasValue, ApplyConditionTo.CurrentValidator);
        }
