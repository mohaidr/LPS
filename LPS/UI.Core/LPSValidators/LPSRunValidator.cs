...
namespace LPS.UI.Core.LPSValidators
{
    internal class LPSRunValidator : LPSCommandBaseValidator<LPSHttpRun.SetupCommand, LPSHttpRun>
    {
        ...
        public LPSRunValidator(LPSHttpRun.SetupCommand command)
        {
            ...
            .NotNull().NotEmpty()
            .Matches("^[a-zA-Z0-9 _-]+$")
            .WithMessage("The Http Run Title does not accept special charachters and should be between 1 and 20 characters")
            .Length(1, 20)
            .WithMessage("The Http Run Title should be between 1 and 20 characters");
