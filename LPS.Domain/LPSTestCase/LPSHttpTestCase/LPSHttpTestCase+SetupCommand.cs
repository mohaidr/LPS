    ...
    public partial class LPSHttpTestCase
    {
        ...
        private void Setup(SetupCommand command)
        {
            ...
            if (command.IsValid && command.LPSTestCaseSetUpCommand.IsValid)
            {
                ...
                this.LPSHttpRequest = new LPSHttpRequest(command.LPSRequest, _logger, _watchdog, _runtimeOperationIdProvider);
        ...
        internal void Clone(LPSHttpTestCase cloneToEntity)
        {
            if (this.IsValid)
            {
                ...
                cloneToEntity.LPSHttpRequest = new LPSHttpRequest(_logger, _watchdog, _runtimeOperationIdProvider);
