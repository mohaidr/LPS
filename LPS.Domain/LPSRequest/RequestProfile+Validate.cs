...
namespace LPS.Domain
{
    ...
    {
        public class Validator: CommandBaseValidator<RequestProfile, RequestProfile.SetupCommand>
        {
            ILogger _logger;
            IRuntimeOperationIdProvider _runtimeOperationIdProvider;
            RequestProfile _entity;
            RequestProfile.SetupCommand _command;
            public Validator(RequestProfile entity, SetupCommand command, ILogger logger, IRuntimeOperationIdProvider runtimeOperationIdProvider)
            {
            ...
            public override RequestProfile Entity => _entity;
