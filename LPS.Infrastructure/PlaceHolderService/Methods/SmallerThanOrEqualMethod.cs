...
namespace LPS.Infrastructure.PlaceHolderService.Methods
{
    ...
    {
        public SmallerThanOrEqualMethod(ParameterExtractorService p, ILogger l, IRuntimeOperationIdProvider op, IVariableManager v, Lazy<IPlaceholderResolverService> r)
            : base(p, l, op, v, r)
        {
        }
