...
namespace LPS.Infrastructure.PlaceHolderService.Methods
{
    ...
    {
        public StrcatMethod(ParameterExtractorService p, ILogger l, IRuntimeOperationIdProvider op, IVariableManager v, Lazy<IPlaceholderResolverService> r, ISessionManager sessionManager)
