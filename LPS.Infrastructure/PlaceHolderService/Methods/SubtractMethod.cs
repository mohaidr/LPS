...
namespace LPS.Infrastructure.PlaceHolderService.Methods
{
    ...
    {
        public SubtractMethod(ParameterExtractorService p, ILogger l, IRuntimeOperationIdProvider op, IVariableManager v, Lazy<IPlaceholderResolverService> r, ISessionManager sessionManager)
        ...
        public override async Task<string> ExecuteAsync(string parameters, string sessionId, CancellationToken token)
        {
            ...
            try
            {
                ...
                if (a is null || b is null)
                    return await FailNumberAsync(variableName, "subtract", token, "Both numeric operands 'a' and 'b' are required.", sessionId: sessionId, isGlobal: isGlobal);
