...
{
    public sealed class ContainsMethod : MethodBase
    {
        public ContainsMethod(ParameterExtractorService p, ILogger l, IRuntimeOperationIdProvider op, IVariableManager v, Lazy<IPlaceholderResolverService> r, ISessionManager sessionManager)
